...
public class AlertDialogLayout extends C0431g0 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: A */
    private void m1674A(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: B */
    private static int m1675B(View view) {
        int z = C3403t.m14676z(view);
        if (z > 0) {
            return z;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1675B(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: C */
    private boolean m1676C(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C3128f.topPanel) {
                    view = childAt;
                } else if (id == C3128f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C3128f.contentPanel && id != C3128f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        m1677l(childCount, i8);
        return true;
    }

    /* renamed from: l */
    private void m1677l(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0431g0.C0432a aVar = (C0431g0.C0432a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.g0$a r15 = (androidx.appcompat.widget.C0431g0.C0432a) r15
            int r2 = r15.f1698b
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = p086f.p111h.p122m.C3403t.m14674y(r17)
