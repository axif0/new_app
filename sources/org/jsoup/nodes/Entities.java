...
public class Entities {
    ...
    /* renamed from: a */
    private static final char[] f18113a = {',', ';'};

    /* renamed from: b */
    private static final HashMap<String, String> f18114b = new HashMap<>();

    /* renamed from: c */
    private static final Document.OutputSettings f18115c = new Document.OutputSettings();
    ...
    public enum EscapeMode {
        ...
        private EscapeMode(String str, int i) {
            Entities.m26341e(this, str, i);
        }

        /* access modifiers changed from: package-private */
        /* renamed from: o */
        public int mo18378o(String str) {
            int binarySearch = Arrays.binarySearch(this.f18117f, str);
            if (binarySearch >= 0) {
                return this.f18118g[binarySearch];
            }
            return -1;
        }
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: q */
        public String mo18379q(int i) {
            int binarySearch = Arrays.binarySearch(this.f18119h, i);
            if (binarySearch < 0) {
                return BuildConfig.FLAVOR;
            }
            String[] strArr = this.f18120i;
            if (binarySearch < strArr.length - 1) {
                int i2 = binarySearch + 1;
                if (this.f18119h[i2] == i) {
                    return strArr[i2];
                }
            }
            return this.f18120i[binarySearch];
        }
    }

    /* renamed from: org.jsoup.nodes.Entities$a */
    static /* synthetic */ class C6416a {
        ...
        static {
            /*
                org.jsoup.nodes.Entities$b[] r0 = org.jsoup.nodes.Entities.C6417b.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f18121a = r0
                org.jsoup.nodes.Entities$b r1 = org.jsoup.nodes.Entities.C6417b.ascii     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = f18121a     // Catch:{ NoSuchFieldError -> 0x001d }
                org.jsoup.nodes.Entities$b r1 = org.jsoup.nodes.Entities.C6417b.utf     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jsoup.nodes.Entities.C6416a.<clinit>():void");
        }
    }

    /* renamed from: org.jsoup.nodes.Entities$b */
    enum C6417b {
        ascii,
        utf,
        fallback;
        ...
        /* renamed from: e */
        static C6417b m26353e(String str) {
    ...
    /* renamed from: b */
    private static void m26338b(Appendable appendable, EscapeMode escapeMode, int i) throws IOException {
        Appendable appendable2;
        String q = escapeMode.mo18379q(i);
        if (q != BuildConfig.FLAVOR) {
            appendable2 = appendable.append('&');
        } else {
            appendable2 = appendable.append("&#x");
            q = Integer.toHexString(i);
        }
        appendable2.append(q).append(';');
    }

    /* renamed from: c */
    private static boolean m26339c(C6417b bVar, char c, CharsetEncoder charsetEncoder) {
        int i = C6416a.f18121a[bVar.ordinal()];
        if (i == 1) {
            return c < 128;
        }
        if (i != 2) {
    ...
    public static int codepointsForName(String str, int[] iArr) {
        String str2 = f18114b.get(str);
        if (str2 != null) {
            iArr[0] = str2.codePointAt(0);
            iArr[1] = str2.codePointAt(1);
            return 2;
        }
        int o = EscapeMode.extended.mo18378o(str);
        if (o == -1) {
            return 0;
        }
        iArr[0] = o;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0050, code lost:
        if (m26339c(r12, r8, r1) != false) goto L_0x007a;
     */
    ...
    static void m26340d(java.lang.Appendable r10, java.lang.String r11, org.jsoup.nodes.Document.OutputSettings r12, boolean r13, boolean r14, boolean r15) throws java.io.IOException {
        /*
            org.jsoup.nodes.Entities$EscapeMode r0 = r12.escapeMode()
            java.nio.charset.CharsetEncoder r1 = r12.mo18270b()
            org.jsoup.nodes.Entities$b r12 = r12.f18096i
            int r2 = r11.length()
            r3 = 0
            r4 = 0
            r5 = 0
        ...
        L_0x0095:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.jsoup.nodes.Entities.m26340d(java.lang.Appendable, java.lang.String, org.jsoup.nodes.Document$OutputSettings, boolean, boolean, boolean):void");
    }

    /* access modifiers changed from: private */
    /* renamed from: e */
    public static void m26341e(EscapeMode escapeMode, String str, int i) {
        int i2;
        String[] unused = escapeMode.f18117f = new String[i];
        int[] unused2 = escapeMode.f18118g = new int[i];
        int[] unused3 = escapeMode.f18119h = new int[i];
        String[] unused4 = escapeMode.f18120i = new String[i];
        ...
        while (!characterReader.isEmpty()) {
            ...
            int parseInt = Integer.parseInt(characterReader.consumeToAny(f18113a), 36);
            ...
            characterReader.advance();
            escapeMode.f18117f[i3] = consumeTo;
            escapeMode.f18118g[i3] = parseInt;
            escapeMode.f18119h[parseInt2] = parseInt;
            escapeMode.f18120i[parseInt2] = consumeTo;
            if (i2 != -1) {
                f18114b.put(consumeTo, new String(new int[]{parseInt, i2}, 0, 2));
            }
            i3++;
        }
        if (i3 == i) {
    ...
    public static String escape(String str, Document.OutputSettings outputSettings) {
        ...
        try {
            m26340d(borrowBuilder, str, outputSettings, false, false, false);
    ...
    /* renamed from: f */
    static String m26342f(String str, boolean z) {
    ...
    public static String getByName(String str) {
        ...
        return new String(new int[]{o}, 0, 1);
    }

    public static Character getCharacterByName(String str) {
        return Character.valueOf((char) EscapeMode.extended.mo18378o(str));
    }

    public static boolean isBaseNamedEntity(String str) {
        return EscapeMode.base.mo18378o(str) != -1;
    }

    public static boolean isNamedEntity(String str) {
        return EscapeMode.extended.mo18378o(str) != -1;
    }

    public static String unescape(String str) {
        return m26342f(str, false);
    }
}
