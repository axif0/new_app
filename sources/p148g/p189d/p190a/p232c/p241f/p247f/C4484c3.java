...
/* renamed from: g.d.a.c.f.f.c3 */
public final class C4484c3 {
    /* renamed from: a */
    private static String m18945a(@NullableDecl Object obj) {
        if (obj == null) {
            return "null";
        }
        try {
    ...
    /* renamed from: b */
    public static String m18946b(@NullableDecl String str, @NullableDecl Object... objArr) {
        int indexOf;
        String valueOf = String.valueOf(str);
        int i = 0;
        for (int i2 = 0; i2 < objArr.length; i2++) {
            objArr[i2] = m18945a(objArr[i2]);
        }
