...
@RealmModule
/* renamed from: io.realm.ObjectPermissionsModuleMediator */
class ObjectPermissionsModuleMediator extends C5721o {

    /* renamed from: a */
    private static final Set<Class<? extends C5763l0>> f16194a;
    ...
    static {
        ...
        f16194a = Collections.unmodifiableSet(hashSet);
    }
    ...
    public <E extends C5763l0> E mo16144b(C5648d0 d0Var, E e, boolean z, Map<C5763l0, C5720n> map, Set<C5781q> set) {
        Object W;
        E e2 = e;
        Class<C5807a> cls = C5807a.class;
        Class<C5811e> cls2 = C5811e.class;
        Class<C5809c> cls3 = C5809c.class;
        Class<C5805a> cls4 = C5805a.class;
        Class<C5808b> cls5 = C5808b.class;
        Class<C5810d> cls6 = C5810d.class;
        Class superclass = e2 instanceof C5720n ? e.getClass().getSuperclass() : e.getClass();
        if (superclass.equals(cls6)) {
            W = C5783q1.m24164X(d0Var, (C5783q1.C5784a) d0Var.mo16219H().mo16773b(cls6), (C5810d) e2, z, map, set);
        } else if (superclass.equals(cls5)) {
            W = C5768m1.m24104V(d0Var, (C5768m1.C5769a) d0Var.mo16219H().mo16773b(cls5), (C5808b) e2, z, map, set);
        } else if (superclass.equals(cls4)) {
            W = C5674i1.m23577V(d0Var, (C5674i1.C5675a) d0Var.mo16219H().mo16773b(cls4), (C5805a) e2, z, map, set);
        } else if (superclass.equals(cls3)) {
            W = C5775o1.m24140W(d0Var, (C5775o1.C5776a) d0Var.mo16219H().mo16773b(cls3), (C5809c) e2, z, map, set);
        } else if (superclass.equals(cls2)) {
            W = C5790s1.m24213W(d0Var, (C5790s1.C5791a) d0Var.mo16219H().mo16773b(cls2), (C5811e) e2, z, map, set);
        } else if (superclass.equals(cls)) {
            W = C5759k1.m24057W(d0Var, (C5759k1.C5760a) d0Var.mo16219H().mo16773b(cls), (C5807a) e2, z, map, set);
        } else {
            throw C5721o.m23892e(superclass);
        }
        return (C5763l0) superclass.cast(W);
    }
    ...
    public <E extends C5763l0> E mo16149i(Class<E> cls, Object obj, C5722p pVar, C5704c cVar, boolean z, List<String> list) {
        ...
        try {
            ...
            C5721o.m23891a(cls);
            if (cls.equals(C5810d.class)) {
                return (C5763l0) cls.cast(new C5783q1());
            }
            if (cls.equals(C5808b.class)) {
                E e = (C5763l0) cls.cast(new C5768m1());
                eVar.mo16239a();
                return e;
            } else if (cls.equals(C5805a.class)) {
                E e2 = (C5763l0) cls.cast(new C5674i1());
                eVar.mo16239a();
                return e2;
            } else if (cls.equals(C5809c.class)) {
                E e3 = (C5763l0) cls.cast(new C5775o1());
                eVar.mo16239a();
                return e3;
                ...
                E e5 = (C5763l0) cls.cast(new C5759k1());
                eVar.mo16239a();
                return e5;
            } else {
                throw C5721o.m23892e(cls);
