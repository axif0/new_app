...
/* renamed from: com.google.android.youtube.player.f.p */
public final class C2495p {
    /* renamed from: a */
    public static Map<String, String> m11224a(Locale locale) {
        ...
        m11225b(hashMap, locale.getLanguage());
        ...
        sb.append("_");
        sb.append(valueOf2);
        m11225b(hashMap, sb.toString());
        return hashMap;
    }

    /* renamed from: b */
    private static void m11225b(Map<String, String> map, String str) {
        if ("af".equals(str)) {
